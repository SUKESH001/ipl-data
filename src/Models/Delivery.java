...
public class Delivery {
    ...
    private String batsmanNameNS;
    private String bowler;
    private String isMatchSuperOver;
    private int wideRuns;
    private int byeRuns;
    private int legByesRuns;
    private int noBallRuns;
    private int penaltyRuns;
    private int batsmanRuns;
    private int extraRuns;
    private int totalRuns;
    private String playerDismissedName;
    ...
    public String getBatsmanNameNS() {
        return batsmanNameNS;
    }

    public void setBatsmanNameNS(String batsmanNameNS) {
        this.batsmanNameNS = batsmanNameNS;
    }
    ...
    public String getIsMatchSuperOver() {
        return isMatchSuperOver;
    }

    public void setIsMatchSuperOver(String isMatchSuperOver) {
        this.isMatchSuperOver = isMatchSuperOver;
    }
    ...
    public void setLegByesRuns(int legByesRuns) {
    ...
    public String getPlayerDismissedName() {
        return playerDismissedName;
    }

    public void setPlayerDismissedName(String playerDismissedName) {
        this.playerDismissedName = playerDismissedName;
    }
